...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 overflow-hidden">
      {/* Background Effects */}
      <div
        className="absolute inset-0 bg-gradient-to-br from-purple-900/20 to-slate-900/20"
        style={{
          backgroundImage: `radial-gradient(circle at 25px 25px, rgba(156, 146, 172, 0.1) 1px, transparent 0)`,
      ...
      <div className="relative container mx-auto px-4 py-20 flex flex-col items-center text-center">
        ...
        <div className="mb-8">
          <Badge
            variant="secondary"
            className="mb-4 bg-purple-600/20 text-purple-300 border-purple-500/30"
          >
